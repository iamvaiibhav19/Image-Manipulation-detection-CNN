...
# label = Label(frame, text="Image Manipulation Detection", font=("Josefin Slab", 30, "bold"), bg="#7128b6", fg="white")
# label.config(height=2)
# label.pack(side=TOP, fill=X)

# input_img = getImage("images/input.png", IMG_WIDTH, IMG_HEIGHT)
# inputPanel = Label(frame, image=input_img, bg="white")
# inputPanel.image = input_img
# inputPanel.pack(side=LEFT, padx=10, pady=10)
...
root = Tk()
root.title("Image Manipulation Detection")
...
resultLabel = Label(text="IMAGE MANIPULATION DETECTION", font=("Josefin Sans", 25, "bold"), justify=CENTER, bg='#7128b6', fg='white')

resultLabel.grid(row=0, column=0, columnspan=3, sticky="nsew",pady=15)
...
# Get the blank image
input_img = getImage("images/input.png", IMG_WIDTH, IMG_HEIGHT)
middle_img = getImage("images/middle-img.jpeg", IMG_WIDTH, IMG_HEIGHT)
...
style = ttk.Style()
style.configure("my.TButton", background="light blue", font=("Josefin Slab", 14), padding=10)
style.configure("myy.TButton", background="#3AA52A",foreground="#3AA52A", font=("Josefin Slab", 14, "bold"), padding=10)
style.configure("start.TButton", background="#1E90B3",foreground="#1E90B3", font=("Josefin Slab", 14, "bold"), padding=10)

uploadButton = ttk.Button(text="UPLOAD IMAGE", style="myy.TButton", command=browseFile)
...
ela.grid(row=5, column=2, columnspan=1, pady=5)
# Button to run the Copy-Move  detection algorithm
copy_move = ttk.Button(text="START", style="start.TButton", command=copy_move_forgery)
copy_move.grid(row=6, column=1, columnspan=1, pady=20)



# Button to exit the program
style = ttk.Style()
style.configure('W.TButton', background="light blue", foreground="red", font=("Josefin Slab", 14, "bold"), padding=10)

quitButton = ttk.Button(text="EXIT", style = 'W.TButton', command=root.quit)
quitButton.grid(row=6, column=2, columnspan=2, pady=5)
